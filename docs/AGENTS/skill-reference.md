...
- 中文治理六维模型：文档、系统界面、协作沟通、流程规范、交付物、代码注释；机器契约见 `docs/harness-engineering/core/chinese-governance.json`，交付字段见 `docs/harness-engineering/core/delivery-artifact-template.md`，协作字段见 `docs/AGENTS/communication-template.md`。
